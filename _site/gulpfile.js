...
gulp.task('serve', function() {
  browserSync({
    ...
    // ```jekyll serve -i ``` uses "0.0.0.0:4000" so use it 4 brosync too.
    // using jekyll (3.0.1) w/ Incremental build!
    proxy: "http://127.0.0.0:4000"

    // • JEKYLL GITHUB PROJECT PAGES (user.github.io/user)
    // ```bundle exec jekyll serve --baseurl ''```
    // uses "0.0.0.0:4000/baseurl"
    // using jekyll (2.4.0)
    // proxy: "0.0.0.0:4000/junglestar.github.io"
  });
